 ...
 */
public class FixedFileInputReader extends AbstractBoundedReader<IndexedRecord> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FixedFileInputReader.class);
    ...
    public FixedFileInputReader(FixedFileInputSource source) {
        super(source);
    }
    ...
    public boolean advance() throws IOException {
        ...
        if (hasMore) {
            ...
            IndexedRecord outOfBandRecord = new GenericData.Record(FixedFileInputProperties.outOfBandSchema);
    ...
    @Override
    public FixedFileInputSource getCurrentSource() {
        return (FixedFileInputSource) super.getCurrentSource();
    }
    ...
    private Schema getRootSchema() {
        if (rootSchema == null) {
            if (runtimeSchema == null) {
                ...
                rootSchema = RootSchemaUtils.createRootSchema(runtimeSchema, FixedFileInputProperties.outOfBandSchema);
            }
        }
        return rootSchema;
    }
